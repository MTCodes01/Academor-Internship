...
// Tried making the 7-day forecast but in the free tier its only having the current weather and 3-hour Forecast 5 days
...
async function getForecast(latitude, longitude) {
  try {
    ...
    box_2.innerHTML = `
      <h1>${Object.keys(dailyForecasts).length}-Day Forecast</h1>
